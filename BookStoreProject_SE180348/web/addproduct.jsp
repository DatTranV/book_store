            ...
            <form action="MainController" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="c_fname" class="text-black">Book ID<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="c_fname" name="bookid">
                  </div>
                  <div class="col-md-6">
                    <label for="c_lname" class="text-black">Author Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="c_lname" name="authorname">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_email" class="text-black">Book Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="" name="bookname" placeholder="">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <label for="c_lname" class="text-black">Image Link <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="c_lname" name="image">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <label for="c_lname" class="text-black">Discount <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="c_lname" name="discount">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="c_fname" class="text-black">Quantity<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="c_fname" name="quantity">
                  </div>
                  <div class="col-md-6">
                    <label for="c_lname" class="text-black">Notsale <span class="text-danger">*</span></label>
                    <input type="number" min="0" max="1" class="form-control" id="c_lname" name="notsale">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-lg-12">
                      <button class="btn-outline-danger" name="action" value="createproduct">Add New Product</button>
                  </div>
                </div>
                   <% if (request.getAttribute("message") != null) { %>
            <h3 style="color: red"><%= request.getAttribute("message") %></h3>
        <% } %>
         <% if (request.getAttribute("message_DUPLICATE") != null) { %>
            <h3 style="color: red"><%= request.getAttribute("message_DUPLICATE") %></h3>
        <% } %>
              </div>
            </form>
          </div>
          <div class="col-md-5 ml-auto">
            <div class="p-4 border mb-3">
              <img src="images/addnew.jpg" style="width: 400px;" height="300px" alt="">
