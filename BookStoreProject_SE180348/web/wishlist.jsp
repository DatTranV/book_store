...
<!--            <li><a href="#">Catalogue</a></li>
            ...
            <div class="bg-light py-3">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 mb-0"><a href="home.jsp">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Wishlist</strong></div>
                    </div>
                </div>
            </div>

            <!-- Ensure Bootstrap 4 or 5 is included -->
            ...
            <div class="container mt-5">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <%
                            ...
                            if (request.getAttribute("list") == null) {
                                list = (List<BooksDTO>) dao.getallProduct(user.getUserID());
                            } else {
                                list = new ArrayList<>();
                            }
                        %>
                    ...
                    <form action="MainController" method="POST">
                        <tr>
                            <td><img src="<%=listBooks.getImages()%>" alt="" style="height: 200px; width: 150px;"></td>
                            <td><%=listBooks.getBookName()%></td>
                            <td><%=listBooks.getAuthorName()%></td>
                            <td><%=listBooks.getCategory()%></td>
                    </form>

                <th>
                    <a href="removeWishList?id=<%= listBooks.getBooksID()%>"
