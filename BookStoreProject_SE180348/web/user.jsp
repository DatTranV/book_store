     ...
     <div class="col-6 col-md-4 order-2 order-md-1 site-search-icon text-left ">
                 ...
                 <form action="MainController" method="post" class="site-block-top-search">
                                    ...
                                    <input name="search" type="text" class="form-control border-0" placeholder="Search"   >
                                         <button type="submit" name="action" value="searchuser" class="btn btn-outline-dark ">Search</button>
                                </form>
    ...
    <table class="table table-striped table-responsive-md">
        ...
        <tbody>
                <% List<UserDTO> list = null;
                            ...
                            if (request.getAttribute("listuser") != null) {
                                list = (List<UserDTO>) request.getAttribute("listuser");
                            } else {
        ...
        <form action="MainController" method="post">                   
                <tr>
                    ...
                    <td><input type="number" min="0" max="2" name="roleid"
                               value="<%= user.getRoleId()%>"
                               class="form-control small-text" ></td>
                    <td><input type="text" 
                               value="***"
                               class="form-control small-text" readonly>
                     <input type="hidden" name="pass" value="<%= user.getPassword()%>">
                    </td>
  
                    <td>      <button type="submit" class="btn btn-warning " name="action" value="updateuser">
                               Update
                            </button></td>
                         
                    <td>
                    <a href="removeUser?id=<%= user.getUserID()%>"
